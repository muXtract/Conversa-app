...
const Message = ({message}) => {
  ...
  return (
    <div className={`chat ${chatClassName}`}>
        ...
        <div className={`chat-bubble text-white  ${bubbleBgColor}  ${shakeClass}  pb-2  font-medium `}  > {message.message} </div>
...
//             </div>
//         </div>
//         <div className={`chat-bubble text-white bg-green-500 `}  > Hey , how's it going </div>
